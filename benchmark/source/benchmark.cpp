...
//     auto re2_enc = (opts.IsUTF8() || opts.IsUTF32()) ? re2::RE2::DefaultOptions :
//     re2::RE2::Latin1; if (partial) {
//       for (auto _ : state) {
...
// // BENCHMARK_CAPTURE(BENCH_LINE, u8"UTF8, p=[a-zA-Z0-9\\_]+nn", u8"[a-zA-Z0-9\\_]+nn"
// /*pattern*/,
// //                   true /*partial*/, ZRegex::CodegenOpts() /*encoding*/,
// //                   "/home/elzarei/bench_data/3200.txt")
// //     ->DenseRange(DFA_LLVM_U8, RE2_TYPE);
